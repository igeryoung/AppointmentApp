...
class _ScheduleScreenState extends State<ScheduleScreen> with WidgetsBindingObserver {
              ...
              children: [
                Scaffold(
                        ...
                        builder: (context, state) {
                          ...
                          return PopupMenuButton<int>(
                            ...
                            onSelected: (int newViewMode) async {
                              _controller.dateService?.setViewMode(newViewMode);
                          ...
                          if (_controller.isDrawingMode)
                            Positioned(
                              ...
                              child: ScheduleDrawingToolbarHelper.buildDrawingToolbar(
                                context: context,
                                getCanvasKey: _controller.getCanvasKeyForCurrentPage,
                                onCanvasStateChange: () => _controller.markNeedsBuild(),
                  ...
                  floatingActionButton: ScheduleFabMenuHelper.buildFabMenu(
                    ...
                    isViewingToday: () => _controller.dateService?.isViewingToday() ?? false,
                    selectedDate: _controller.selectedDate,
                    lastActiveDate: _controller.lastActiveDate,
                    saveDrawing: () => _controller.saveDrawing(context),
  ...
  Widget _build3DayView(
    ...
    return ScheduleBody(
      ...
      getEventTypeColor: (context, eventType) => controller.eventService?.getEventTypeColor(eventType) ?? Colors.grey,
      onEditEvent: (event) => controller.eventService?.editEvent(event),
      onShowEventContextMenu: (event, position) => controller.eventService?.showEventContextMenu(event, position),
      ...
      onEventDrop: (event, newStartTime) => controller.eventService?.handleEventDrop(event, newStartTime, context),
      ...
      onChangeType: controller.eventService?.selectedEventForMenu != null
          ? () => controller.eventService?.handleMenuAction('changeType', controller.eventService!.selectedEventForMenu!, context)
          : null,
      onChangeTime: controller.eventService?.selectedEventForMenu != null
          ? () => controller.eventService?.handleMenuAction('changeTime', controller.eventService!.selectedEventForMenu!, context)
          : null,
      onScheduleNextAppointment: controller.eventService?.selectedEventForMenu != null
          ? () => controller.eventService?.scheduleNextAppointment(controller.eventService!.selectedEventForMenu!, context)
          : null,
      onRemove: controller.eventService?.selectedEventForMenu != null
          ? () => controller.eventService?.handleMenuAction('remove', controller.eventService!.selectedEventForMenu!, context)
          : null,
      onDelete: controller.eventService?.selectedEventForMenu != null
          ? () => controller.eventService?.handleMenuAction('delete', controller.eventService!.selectedEventForMenu!, context)
          : null,
      onCheckedChanged: controller.eventService?.selectedEventForMenu != null
          ? (isChecked) => controller.eventService?.toggleEventChecked(controller.eventService!.selectedEventForMenu!, isChecked)
          : null,
    );
  }
}
