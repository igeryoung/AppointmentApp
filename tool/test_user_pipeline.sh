...
if [[ "$RUN_FAST" == "1" ]]; then
  ...
  run_step "Pipeline 08 - Drawing Save/Load/Update/Clear" "flutter test test/app/unit/repositories/drawing/drawing_repository_impl_test.dart --reporter compact"
