...
| [V] | [ ] | Register device with valid server config | Setup succeeds and app navigates to Book List | P12 - EVENT-INTEG-010 @ `test/app/integration/event_metadata/event_integ_010_device_session_contract_test.dart` |
...
| [ ] | [ ] | Pull server data after reconnect | Pulled data merges cleanly with local state | Partial: P12 - EVENT-INTEG-006 @ `test/app/integration/event_metadata/event_integ_005_server_only_contract_test.dart` |
